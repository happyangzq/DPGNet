...
parser.add_argument('--detector_path', type=str, 
                    default='/opt/data/private/config/test.yaml',
...
def test_one_dataset(model, data_loader,epoch):
    prediction_lists = []
    #feature_lists = []
    label_lists = []
    for i, data_dict in tqdm(enumerate(data_loader), total=len(data_loader)):
        ...
        predictions = inference(model, data_dict,epoch)
...
def test_epoch(model, test_data_loaders,epoch):
    ...
    for key in keys:
        ...
        predictions_nps, label_nps = test_one_dataset(model, test_data_loaders[key],epoch)
...
def inference(model, data_dict,epoch):
    predictions = model(data_dict, epoch,inference=True)
    return predictions
...
def main():
    ...
    try:
        ...
        # start testing
        best_metric = test_epoch(model, test_data_loaders,epoch)
        print('===> Test Done!')
